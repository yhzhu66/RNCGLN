...
parser.add_argument('--r1', type=float, default=0.1, help='hyparameter in loss function.')
...
parser.add_argument('--lr', type=float, default=0.0004, help='learning ratio.')
...
parser.add_argument('--lab_noi_rat', type=float, default=0.1, help='noise ratio for label.')
parser.add_argument('--noise', type=str, default='uniform', help='the type for label noise generation.')
parser.add_argument('--gra_noi_rat', type=float, default=0.3, help='noise ratio for graph.')
